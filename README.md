...
- `-abbrev` turns on recognition of abbreviations for character names when indicating speaker (it is not universal, i.e. you can write a transcript with a mix of abbreviated and non-abbreviated names).
